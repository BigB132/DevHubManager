...
module.exports = async (client, message) => {
    if(message.content === "?hire") {
        ...
        const hireChannel = await message.guild.channels.create({
            ...
            description: `This channel got generated by/for ${projectData.ownerId} for his project ${projectData.projectName}`,
        ...
        projectData.save();
        await Preview.sendMessage(hireChannel.id, message.guild);
